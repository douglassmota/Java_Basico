 ...
 */
package com.cursoemvideo.exercicio09;
...
public class TelaEquacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Calculadora de Equação 2º Grau");
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        ...
        if (delta >= 0){
            ...
            String raizFormatada1 = df.format(raiz1);
            String raizFormatada2 = df.format(raiz2);
            
            lblRaiz.setText("As raizes são " + raizFormatada1 + " e " + raizFormatada2);
        }else{
            lblRaiz.setText("A equação não possui raizes");
        }
